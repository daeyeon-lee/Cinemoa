import { UserInfoResponse, UserInfoErrorResponse, FundingProposalsResponse, FundingProposalsErrorResponse, ParticipatedFundingResponse, ParticipatedFundingErrorResponse } from '@/types/mypage';
