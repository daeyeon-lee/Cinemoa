...
const CategoryBreadcrumb: React.FC<CategoryBreadcrumbProps> = ({ categoryId, primaryCategory, secondaryCategory }) => {
  ...
  return <div className="p1 text-tertiary">{getCategoryDisplay()}</div>;
};
