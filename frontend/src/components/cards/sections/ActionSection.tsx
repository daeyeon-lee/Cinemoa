...
const ActionSection: React.FC<ActionSectionProps> = ({
  ...
  if (loadingState === 'loading') {
    return (
      <div className={`px-4 py-4 bg-slate-800 border-t border-gray-700 flex flex-col gap-${type === 'funding' ? '4' : '6'}`}>
        {type === 'funding' && (
      ...
      {type === 'funding' && price !== undefined && (
        <div className="self-stretch inline-flex justify-between items-center">
          <div className="inline-flex flex-col justify-start items-start">
            <div className="justify-center text-slate-300 text-base font-['Noto_Sans_KR'] leading-normal">
              1인당
            </div>
          </div>
          <div className="inline-flex flex-col justify-start items-start">
        ...
        {type === 'funding' ? (
          ...
          <>
            ...
            >
              ...
              <div className="justify-start text-slate-400 text-lg font-bold font-['Pretendard'] leading-7">
                공유
              </div>
            </div>
          </>
