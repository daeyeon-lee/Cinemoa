...
public class ClaudeApiRequest {
    ...
    public static ClaudeApiRequest createSummaryRequest(String text) {
        String prompt = String.format(
                "음은 상영물(영화/시리즈/공연/스포츠중계)의 상세 설명입니다. 아래 내용을 2-3줄로 요약해주세요. 만약 외국어일 경우 한국어로 번역한 다음 요약을 수행해 주세요. 요약 시 다음 사항을 준수해 주세요: - 핵심 내용과 매력 포인트를 포함- 불필요한 세부사항은 제외- 관객이 흥미를 느낄 수 있도록 작성 - 영화 소개 같이 생동감 있게 작성 - 딱딱한 문어체 피해줘. - ~입니다. ~있어요. 같은식으로 문장 끝내기 금지. [원본 텍스트]\n\n%s",
                text);
