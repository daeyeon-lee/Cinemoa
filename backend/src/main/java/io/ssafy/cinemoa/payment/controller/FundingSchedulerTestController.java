...
public class FundingSchedulerTestController {
    ...
    public String testCheckFundingResults(@RequestParam String targetDate) {
    ...
    public String testTransferToCinemaAccounts(@RequestParam String targetDate) {
    ...
    public String testFullScheduler(@RequestParam String targetDate) {
