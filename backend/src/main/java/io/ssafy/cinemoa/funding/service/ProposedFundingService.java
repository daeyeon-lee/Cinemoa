...
public class ProposedFundingService {
    ...
    public CursorResponse<CardTypeFundingInfoDto> getProposedFunding(Long userId, String type, String cursor, Integer limit) {
        // 1. 사용자 존재 여부 확인
        ...
        return proposedFundingRepository.findProposedFundings(userId, fundingType, request);
    }
