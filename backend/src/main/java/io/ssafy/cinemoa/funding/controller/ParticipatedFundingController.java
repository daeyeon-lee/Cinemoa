...
public class ParticipatedFundingController {
     ...
     * @param state 참여 상태 필터 (ON_PROGRESS, SUCCESS, FAILED 등) - 선택적 파라미터
    ...
    public ResponseEntity<ApiResponse<ParticipatedFundingListResponse>> getParticipatedFundings(
        ...
        ParticipatedFundingListResponse result = participatedFundingService.getParticipatedFundings(userId, state, cursor, limit);
